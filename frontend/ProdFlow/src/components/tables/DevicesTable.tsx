...
export const DevicesTable: React.FC<Props> = ({ data, loading, onEdit, onDelete }) => {
  ...
  const columns = useMemo(() => [
    ...
    { title: "Android ID", dataIndex: "android_id", key: "android_id", width: isMobile ? 120 : undefined },
    {
      title: "Actions",
      key: "actions",
